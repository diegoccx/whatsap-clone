...
function simulateConversation() {
  ...
  function addMessagesWithDelay(count) {
    if (count > 0) {
      addMessage();
      setTimeout(() => addMessagesWithDelay(count - 1), 18000); // 18 segundos de atraso entre mensagens
    }
  }

  // Adiciona a primeira mensagem imediatamente
  addMessagesWithDelay(30); // 30 mensagens com 18 segundos de atraso entre elas
}
